//---------------------------------------------------------------------------------------
//File and Drive status -       Ranjith Gopalankutty                    24-04-2017
// 
                     ...
                     if ((ReportTitle.match("KEYED FILE IS FULL"))) 
                      {
                       ...
                       { 
                        ...
                        while (!ReportTitle.match("KEYED")  && !ReportTitle.match("LOG"))
                         ...
                         if(!isNaN(readLine.substring(0,5)) && (readLine.length > 0))

                          {

                               LogName[M] = LogName[M] = LogName[M] + " " + readLine.substring(0,5)
                               CountLog = CountLog + 1
...
//	  
//  Below loops identifies the status of each report
//
   ...
   statusObject.Identifier = componentIdentifier;	
       ...
       if(isFileError)
        ...
        {    
            ...
            ErrorData.push([" " + ErrorFile + " " + DriveCount + " " + CountLog]);
