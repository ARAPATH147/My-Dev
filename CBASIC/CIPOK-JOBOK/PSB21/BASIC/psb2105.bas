...
!%INCLUDE NIADFDEC.J86  ! New Items in Active Deals File                    !AMW
...
!       CALL OSSHELL("IF EXIST W:\RAMDINF.BIN RESTRICT W:\RAMDINF.BIN")     !AMW
!       CALL OSSHELL("IF EXIST W:\RAMDINF.BIN DEL W:\RAMDINF.BIN")          !AMW
        
!       CALL OSSHELL("IF EXIST W:\NIADF.BAK   RESTRICT W:\NIADF.BAK")       !AMW
!       CALL OSSHELL("IF EXIST W:\NIADF.BAK   DEL W:\NIADF.BAK")            !AMW
