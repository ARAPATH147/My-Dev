...
Public Class PowerState
    ...
    Public Sub UnSetSleepTimeOut()
        ...
        Try
            ...
            AppContainer.GetInstance().obLogger.WriteAppLog("PowerState:: UnSetSleepTimeOut:: power settings updated in registry:", _
                                                            Logger.LogLevel.RELEASE)
        Catch ex As Exception
            'Add the exception to the device log.
            AppContainer.GetInstance().obLogger.WriteAppLog("PowerState:: UnSetSleepTimeOut:: Error in changing the power settings key value in registry:" & _
    ...
    Public Sub SetSleepTimeOut(ByVal iTimeOut As Integer)
        ...
        Try
            ...
            NotifyWinUserSystem(3)
            AppContainer.GetInstance().obLogger.WriteAppLog("PowerState:: SetSleepTimeOut:: power settings updated in registry:", _
                                                            Logger.LogLevel.RELEASE)
        Catch ex As Exception
            'Add the exception to the device log.
            AppContainer.GetInstance().obLogger.WriteAppLog("PowerState:: SetSleepTimeOut:: Error in changing the power settings Key in registry:" & _
                                                              ex.Message.ToString(), Logger.LogLevel.RELEASE)
        End Try
    End Sub
End Class
