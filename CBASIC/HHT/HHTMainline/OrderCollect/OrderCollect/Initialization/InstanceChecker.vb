...
Public Class InstanceChecker
    ...
    Public Function fIsInstanceRunning() As Boolean
        ...
        If Marshal.GetLastWin32Error() = NATIVE_ERROR_ALREADY_EXISTS Then
            'Message M128
            MessageBox.Show("Another instance of the application is  already active. Please close it and retry.", _
    ...
    Public Function fClearMutex() As Boolean
        ...
        Catch ex As Exception
            m_hMutex = Nothing
            'xxx objAppContainer.objLogger.WriteAppLog("Exception occured at ClearMutex: " + ex.StackTrace, Logger.LogLevel.RELEASE)
            MessageBox.Show("Cannot ClearMutex | " & Err.Description & " : " & Err.Number, "Exception", _
