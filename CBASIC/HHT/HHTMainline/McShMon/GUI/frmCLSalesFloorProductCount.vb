Public Class frmCLSalesFloorProductCount
...
#End If
    ...
    Private Sub FreezeControls()
        Try
            ...
            Me.Btn_CalcPad_smallsf.Enabled = False
        Catch ex As Exception
    ...
    Private Sub UnFreezeControls()
        Try
            ...
            Me.Btn_CalcPad_smallsf.Enabled = True
            objStatusBar.SetMessage(CustomStatusBar.MSGTYPE.ACT_DATATTIME)
        Catch ex As Exception
            objAppContainer.objLogger.WriteAppLog("Error while Freeze / Unfreezing Controls, " + ex.Message, Logger.LogLevel.RELEASE)
        End Try
...
#End If
    ...
    Private Sub Btn_CalcPad_smallsf_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_CalcPad_smallsf.Click
        Try
            FreezeControls()
            If Not (CLSessionMgr.GetInstance.CheckLocationSelection()) Then
                UnFreezeControls()
            ...
            If objSftKeyPad.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Else
                    CLSessionMgr.GetInstance().ProcessSalesFloorItemCounted(lblProductCodeDisplay.Text, lblShelfQty.Text, lblBootsCodeDisplay.Text)
                End If
            End If
            objStatusBar.SetMessage(CustomStatusBar.MSGTYPE.ACT_DATATTIME)
#If NRF Then
