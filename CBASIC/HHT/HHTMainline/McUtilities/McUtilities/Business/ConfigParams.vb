Imports System.Xml
''' <summary>
''' Class containing variables representing each configuration key in the 
''' configuration file. The variables used to access a configuration key should
''' be in the same as the key in the configuration file.
''' 
''' Any sub key present in the configuration file should be represented by
''' a corresponding set of variables in a class and an object of the class
''' should be located in the same position as the sub key.
''' </summary>
''' <remarks></remarks>
'''
''' * Modification Log
...
''' <Summary>
''' MCF changes - Defined variables for Primary, Secondary and Active IP
''' </Summary>
'''****************************************************************************
Public Class ConfigParams
    ...
    Public LastBuildSHELFDESC As DateTime
...
Public Class IPParams
    ...
    Public PrimaryIP As String
    Public SecondaryIP As String
    Public ActiveIP As String
