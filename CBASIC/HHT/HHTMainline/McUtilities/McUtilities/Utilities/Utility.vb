...
#Region "IP ADDRESS"
    ...
    Public Shared Function GetIPAddress() As String
        ...
        Try
            ...
            objAppContainer.objLogger.WriteAppLog("Utility:: GetIpAddress:: Getting DNS name" + _
                                                  sDnsName, Logger.LogLevel.INFO)
            m_IpHostEntry = System.Net.Dns.GetHostEntry(sDnsName)
            objAppContainer.objLogger.WriteAppLog("Utility:: GetIpAddress:: Getting IP Host", _
                                                  Logger.LogLevel.INFO)
            m_aIPAddressArray = m_IpHostEntry.AddressList()
            objAppContainer.objLogger.WriteAppLog("Utility:: GetIpAddress:: Getting IP address" + _
                ...
                For iIndex = 0 To m_aIPAddressArray.Length - 1
                    ...
                    If m_aIPAddressArray(iIndex).ToString() = "127.0.0.1" And _
                       m_aIPAddressArray.Length = 1 Then
                        ...
                        objAppContainer.objLogger.WriteAppLog("Utility:: GetIpAddress:: IP of device is" _
                                                              & strIP, _
            ...
            End If
        Catch ex As Exception
            objAppContainer.objLogger.WriteAppLog("Utility:: GetIpAddress:: Device IP retreival failed" + _
...
#Region "DEVICE SERIAL NO"
    Public Function GetSerialNumber(Optional ByVal bTrim As Boolean = True) As String
#If NRF Then
        Try
            ...
            If objTerminalInfo.ESN.Length > 12 And bTrim Then
