...
Public Class InstanceChecker
    ...
    Public Function IsInstanceRunning() As Boolean
        ...
        If Marshal.GetLastWin32Error() = NATIVE_ERROR_ALREADY_EXISTS Then
            'MessageBox.Show(MessageManager.GetInstance().GetMessage("M118"), "Warning", _
    ...
    Public Function ClearMutex() As Boolean
        ...
        Catch ex As Exception
            m_hMutex = Nothing
            objAppContainer.objLogger.WriteAppLog("Exception occured at ClearMutex: " + ex.StackTrace, Logger.LogLevel.RELEASE)
        End Try
    End Function
End Class
