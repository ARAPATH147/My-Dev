...
Public Class FileIO
    ...
    Public Shared Function WriteDataIntoFile(ByVal sFileName As String, ByVal sRecord As String, ByVal bAppend As Boolean) As Boolean
        ...
        Return True
    End Function
    Public Shared Function CreateDirectory(ByVal strDirectoryPath As String) As Boolean
        Try
    ...
    Public Shared Function LogFileDelete()
        Try
            ...
            For Each strFileName In _
                   Directory.GetFiles(ConfigDataMgr.GetInstance().GetParam(ConfigKey.LOGFILE_PATH))
