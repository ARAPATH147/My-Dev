...
Public Class Logger
    ...
    Private strLogFileName As String ' = "AppLogs_" + DateTime.Now.ToString("MMddyyHHmm") + ".txt"
    Public Sub New()
...
#If NRF Then
        ...
        WriteAppLog(DeviceMacAddress + ":: Goods In :: " + DateTime.Now.ToString("MMddyyyHHmmss"))
#End If
    End Sub
        ...
        Try
            If strRelease Then
                If eLoggingLevel = LogLevel.RELEASE Then
                    ...
                    Dim strLogFilePath As String = Path.Combine(ConfigDataMgr.GetInstance().GetParam(ConfigKey.LOGFILE_PATH), strLogFileName)
