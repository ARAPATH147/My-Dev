...
Public Class MessageManager
    ...
    Private Function OpenXML() As Boolean
        ...
        Try
            ...
            If System.IO.File.Exists(ConfigDataMgr.GetInstance().GetParam(ConfigKey.MESSAGE_FILE_PATH)) Then
                objReader.Load(ConfigDataMgr.GetInstance().GetParam(ConfigKey.MESSAGE_FILE_PATH))
            Else
    ...
    Public Function GetMessage(ByVal nodeId As String) As String
        ...
        Try
            If bFileExist Then
                ...
                GetMessage = objReader.GetElementsByTagName(nodeId).Item(0).InnerText
        ...
        Catch ex As Exception
            GetMessage = "Specified node not present in XML"
        End Try
