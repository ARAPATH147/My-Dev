...
#If RF Then
    Public Shared Sub Update()
        ...
        'changes for backup thread synchronization 
        ' BLUtilities.WaitOne()
        ...
        For i As Integer = 0 To m_settings.Count - 1
            ...
            mxmlwriter.WriteRaw(m_settings.[Get](i))
            mxmlwriter.WriteEndAttribute()
        ...
        'changes for backup thread synchronization 
        'BLUtilities.ReleaseMutex()
    End Sub
        Public Shared Function GetParam(ByVal Param As String) As String
    ...
    End Function
     Private Shared Sub LoadAppConfig()
        'changes for backup thread synchronization 
        ' BLUtilities.WaitOne()
        m_settingsPath = Path.Combine(Macros.APPCONFIG_FILE_PATH, "McGdIn_Config.xml")
        ...
        'BLUtilities.ReleaseMutex()
    End Sub
        Public Shared Sub SetParam(ByVal Param As String, ByVal value As String)
        Try
