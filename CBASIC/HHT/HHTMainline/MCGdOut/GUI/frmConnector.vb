...
''' <Summary>
''' MCF changes - Property change when user selects cancel in reconnect message box
''' </Summary>
'''********************************************************************************
...
Private Shared Function PlaySound(ByVal szSound As String, ByVal hModule As IntPtr, ByVal flags As Integer) As Integer
    ...
    End Enum
    ''' <summary>
    ''' To play sound as requested by the function call.
    ''' </summary>
    ...
    ''' <summary>
    ''' Proerty is set when user selects cancel in reconnect message box.
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    ...
    End Sub
    ''' <summary>
    ''' Set the status text in the message box.
    ''' </summary>
    ...
    End Sub
    ''' <summary>
    ''' Handle Cancel button click on a reconnect message box.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    End Sub
    ''' <summary>
    ''' Function is invoked when user select Retry on timeout message box.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    End Sub
    ''' <summary>
    ''' Function is invoked when user select Cancel on timeout message box.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
