...
\/* Added new field 'SAP order number'                             */
\/*                                                                */
\/******************************************************************/
...
\/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   FUNCTION READ.CRTN PUBLIC
      ...
      READ FORM "T9,C1,C18,C5,C1,C1,C12,C3,C420,C10,C29";           \   !CRR
           #CRTN.SESS.NUM%                                          \
           KEY CRTN.KEY$;                                           \
               CRTN.STATUS$,                                        \
               CRTN.ASN.CODE$,                                      \
...
\/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   FUNCTION WRITE.CRTN PUBLIC
      ...
      WRITE FORM "C8,C1,C18,C5,C1,C1,C12,C3,C420,C10,C29";          \   !CRR
           #CRTN.SESS.NUM%;                                         \
               CRTN.KEY$,                                           \
               CRTN.STATUS$,                                        \
               CRTN.ASN.CODE$,                                      \
