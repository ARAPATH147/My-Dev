...
srpdf.open.err:
   ...
   !      CREATE POSFILE SRPDF.FILE.NAME$ KEYED 4,,,3000                \ CRG
...
srsxf.open.err:
   ...
   ! Planner refresh from Inctactix has been increased over time so     ! CRG 
   ! doubling the file capacity to 1.5 times of its current size        ! CRG 
   
   !      CREATE POSFILE SRSXF.FILE.NAME$ KEYED 6,,,60000               \ CRG
...
CREATE.SRPOG:
   ...
   ! CREATE POSFILE SRPOG.FILE.NAME$ KEYED 4,,,3000                   \ ! CRG
...
CREATE.SRMOD:
   ...
   ! Planner refresh from inctactix has been increased over time so     ! CRG 
   ! doubling the file capacity to double of its current size           ! CRG 
   ! CREATE POSFILE SRMOD.FILE.NAME$ KEYED 6,,,4000                   \ ! CRG
